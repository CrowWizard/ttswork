...
class AnalyzerService:
    ...
    def _generate_paragraph_summary(self, full_text: str) -> list[Paragraph]:
                ...
                "paragraphs": [
                    {
                        ...
                        "summary": "本段围绕洗头误区展开，核心结论是过度清洁会加重头皮问题，作用是用日常错误制造焦虑并拉住开头注意力。",
        ...
        prompt = (
            ...
            "必须同时包含三类信息: 1) 本段主要讲什么主题或情节; 2) 本段给出的核心观点、结论或冲突; "
            "3) 本段在整条视频中的作用, 例如铺垫背景、制造悬念、解释原因、证明观点、推动转折、给出方法或引导行动。\n"
            "summary 写法约束: 优先使用“本段围绕...展开，核心结论/冲突是...，作用是...”这类句式; "
    ...
    def _step1_extract_structure(self, text_for_structure: str, total_duration: float) -> StructureExtract:
        prompt = (
            ...
            "同时包含三类信息: 1) 本段主要讲什么主题或情节; 2) 本段给出的核心观点、结论或冲突; "
            "3) 本段在整条视频中的作用, 例如铺垫背景、制造悬念、解释原因、证明观点、推动转折、给出方法或引导行动;\n"
            "narrative_arc.event 写法约束: 优先使用“本段围绕...展开，核心结论/冲突是...，作用是...”这类句式; "
